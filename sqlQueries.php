<?php
  ...
  $sqlGetDataForLinearChart = "SELECT date, ROUND(quality * 100,2) AS quality , ROUND(quality * availability,2) * 100 as OEE FROM daily_data;"; //* zapytanie oblicza wskaźnik OEE
